...
<?php 
    ...
    $result = mysqli_query($mysqli, "SELECT sekolah as sekolah,dalam,luar from 
        pendaftaran order by sekolah asc");

    $sekolah ="";
    $dalam ="";
    $luar="";
    while ($res = mysqli_fetch_array($result)) {
        $sekolah=$sekolah."'".$res['sekolah']."',";
        $dalam=$dalam."".$res['dalam'].",";
        $luar=$luar."".$res['luar'].",";
    }
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Grafik Pendaftaran 10 SMP Negeri Bandung Pilihan Pertama ',
        format: '1,000'
    },
    yAxis: {
        title: 'SMP'
...
tui.chart.barColumn(container, data, options);
</script>
